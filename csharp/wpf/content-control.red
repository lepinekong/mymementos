...
Memento: [
    ...
    Title: {WPF Content Control}

    Source: [
        .title: {ReAdABLE Source [(What is the ReAdABLE Human Format?)](http://readablehumanformat.com)}
        .text: {[http://mymementos.space/csharp/wpf/content-control.red](https://github.com/lepinekong/mymementos/blob/master/csharp/wpf/content-control.red)
        }
        .Published-Url: http://mymementos.space/csharp/wpf/content-control
    ]      

    Introduction: [
        .title: {What is Content Control}
        .text: {Content Control is used to store content either entered by the user or read from any other data source or for showing another control dynamically.
