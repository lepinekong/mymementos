...
# How to customize leap theme


### Pre-Requisites

Setup leap theme in Github

### Customize _config.yml

Edit title and sub-title in _config.yml:
![https://i.imgur.com/9Q3lLSM.png](https://i.imgur.com/9Q3lLSM.png)
                    

### Create _layouts\default.html

Paste in it source code:
